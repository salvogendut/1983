...
V9990DisplayMode v9990_display_mode(const MsxV9990 *v9990) {
    unsigned mode;
...
const char *v9990_mode_name(const MsxV9990 *v9990) {
...
bool v9990_display_active(const MsxV9990 *v9990) {
    return v9990 && v9990->enabled && !v9990->system_reset &&
           (v9990->registers[V9990_REG_CONTROL] & 0x80) != 0;
}

static unsigned map_cpu_address(const MsxV9990 *v9990,
                                unsigned address) {
    switch (v9990_display_mode(v9990)) {
        case V9990_MODE_P1:
...
static u8 read_direct(const MsxV9990 *v9990, unsigned address) {
    return v9990->vram[address & (V9990_VRAM_SIZE - 1)];
}

static void write_direct(MsxV9990 *v9990, unsigned address, u8 value) {
    v9990->vram[address & (V9990_VRAM_SIZE - 1)] = value;
}

static u8 read_bx(const MsxV9990 *v9990, unsigned address) {
    return read_direct(v9990, transform_bx(address));
}

static u8 read_p2(const MsxV9990 *v9990, unsigned address) {
    return read_direct(v9990, transform_p2(address));
}

static unsigned register_address(const MsxV9990 *v9990, unsigned base) {
    return (unsigned)v9990->registers[base] |
           ((unsigned)v9990->registers[base + 1] << 8) |
           (((unsigned)v9990->registers[base + 2] & 7u) << 16);
}

static void set_register_address(MsxV9990 *v9990, unsigned base,
                                 unsigned address) {
    address &= V9990_VRAM_SIZE - 1;
...
static void update_irq(MsxV9990 *v9990) {
    v9990->irq =
        (v9990->pending_irqs &
         v9990->registers[V9990_REG_INTERRUPT_ENABLE]) != 0;
}

static void finish_command(MsxV9990 *v9990) {
...
static unsigned image_width(const MsxV9990 *v9990) {
    return 256u << ((v9990->registers[V9990_REG_SCREEN_MODE_0] >> 2) & 3);
}

static unsigned bits_per_pixel(const MsxV9990 *v9990) {
...
static unsigned pixel_address(const MsxV9990 *v9990,
...
static u16 point(const MsxV9990 *v9990, unsigned x, unsigned y) {
    unsigned bpp = bits_per_pixel(v9990);
...
static void pset(MsxV9990 *v9990, unsigned x, unsigned y, u16 colour) {
    unsigned bpp = bits_per_pixel(v9990);
    unsigned address = pixel_address(v9990, x, y);
...
static unsigned wrapped_nx(const MsxV9990 *v9990) {
    return v9990->command_nx ? v9990->command_nx : 2048;
}

static unsigned wrapped_ny(const MsxV9990 *v9990) {
...
static void load_command_registers(MsxV9990 *v9990) {
...
static void run_immediate_command(MsxV9990 *v9990, u8 command) {
...
static void write_register(MsxV9990 *v9990, unsigned reg, u8 value) {
...
static u8 read_register(const MsxV9990 *v9990, unsigned reg) {
...
static u32 palette_colour(const MsxV9990 *v9990, unsigned index) {
    index &= 63;
...
static u32 bitmap_colour(const MsxV9990 *v9990,
...
static unsigned pattern_number(const MsxV9990 *v9990, bool p2,
                               unsigned name_table,
                               unsigned x, unsigned y) {
...
static unsigned pattern_pixel(const MsxV9990 *v9990, bool p2,
...
static u32 render_p1_pixel(const MsxV9990 *v9990,
                           unsigned x, unsigned y,
                           bool *foreground) {
...
static u32 render_p2_pixel(const MsxV9990 *v9990,
                           unsigned x, unsigned y,
                           bool *foreground) {
...
static u8 pattern_mode_read(const MsxV9990 *v9990,
...
static void render_pattern_sprites(const MsxV9990 *v9990,
...
static V9990CursorLine bitmap_cursor_line(const MsxV9990 *v9990,
...
static void render_bitmap_cursors(const MsxV9990 *v9990,
                                  V9990DisplayMode mode,
                                  unsigned y, unsigned width,
                                  u32 *pixels) {
...
void v9990_render(MsxV9990 *v9990) {
    V9990DisplayMode mode;
    unsigned width;
    unsigned height;
    bool overscan;
...
void v9990_init(MsxV9990 *v9990) {
    if (v9990)
        memset(v9990, 0, sizeof(*v9990));
}

void v9990_destroy(MsxV9990 *v9990) {
    if (!v9990)
        return;
    free(v9990->vram);
    free(v9990->pixels);
...
int v9990_set_enabled(MsxV9990 *v9990, bool enabled, unsigned slot) {
    if (!v9990)
        return -1;
    if (!enabled) {
        v9990->enabled = false;
    ...
    if (!v9990->vram || !v9990->pixels) {
        v9990_set_enabled(v9990, false, 0);
        return -1;
    }
    v9990->enabled = true;
    v9990->slot = slot;
...
void v9990_reset(MsxV9990 *v9990) {
...
bool v9990_io_read(MsxV9990 *v9990, u16 port, u8 *value) {
    unsigned low;
...
bool v9990_io_write(MsxV9990 *v9990, u16 port, u8 value) {
    unsigned low;
...
void v9990_begin_frame(MsxV9990 *v9990, unsigned frame_cycles) {
    if (!v9990 || !v9990->enabled)
        return;
...
void v9990_advance(MsxV9990 *v9990, unsigned cycles) {
    unsigned previous;
    unsigned threshold;
...
void v9990_end_frame(MsxV9990 *v9990) {
    if (!v9990 || !v9990->enabled)
        return;
    v9990_render(v9990);
}
